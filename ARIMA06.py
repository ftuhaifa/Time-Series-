# -*- coding: utf-8 -*-
"""
Created on Sun Jan  1 07:23:50 2023
...
prediction = pd.DataFrame(model_fit.predict(n_periods = 40), index = test.index)


# Get forecast 500 steps ahead in future
#pred_uc = model_fit.get_forecast(steps=40)
...
#prediction = pred_ci ["lower Rate of death"]
...
MedNote['for'] = pred_ci ["upper Rate of death"]
#start=90,end=103,dynamic=True
